...
import sound1 from "../sounds/mixkit-arcade-fast-game-over-233.wav";
import "./Area.css";

import sound2 from "../sounds/mixkit-long-pop-2358.wav";
import "./Area.css";

/**
 * TODO: add a more elegant UX for before a game starts and after a game ends.
 * A game probably shouldn't gameStart until the user presses an arrow key, and
